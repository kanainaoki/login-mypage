	...
	<main>
		<form action="register_confirm.php" method="post" enctype="multipart/form-data">
			<div class="form_contents">
				<h2>会員登録</h2>
				<div class="name">
					<div class="hissu">必須</div><lebel>氏名</lebel><br>
				...
				<div class="password">
					...
					<input type="password" class="formbox" size="40" name="comfirm_password" id="confirm" oninput="ConfirmPassword(this)" required>
				</div>
				<div class="picture">
				...
				<div class="toroku">
					<input type="submit" class="subit_button" size="35" value="登録する">
				</div>
			</div>	
		</form>
